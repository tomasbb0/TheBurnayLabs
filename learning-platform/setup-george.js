...
async function setup() {
  ...
  await addDoc(diagRef, {
    ...
    description: 'Complete Portuguese level assessment - Colors, Numbers, Body Parts, Family, Commands, Oral Production',
    status: 'pending',
    createdAt: new Date(),
    sections: [
      {
        ...
        items: [
          ...
          { portuguese: 'Amarelo', english: 'Yellow', emoji: '🟡', response: '' },
      ...
      },
      {
        ...
        items: [
          { portuguese: 'Olá!', english: 'Hello! (wave)', emoji: '👋', response: '' },
          { portuguese: 'Bate palmas!', english: 'Clap your hands!', emoji: '👏', response: '' },
          { portuguese: 'Salta!', english: 'Jump!', emoji: '🦘', response: '' },
          { portuguese: 'Senta!', english: 'Sit down!', emoji: '🪑', response: '' },
          { portuguese: 'Dá-me a mão', english: 'Give me your hand', emoji: '🤝', response: '' }
        ],
        score: null,
        maxScore: 5
      },
      {
        ...
        items: [
          { portuguese: 'Olá! Como te chamas?', english: 'Hello! What is your name?', emoji: '🙋', response: '' },
          { portuguese: 'Quantos anos tens?', english: 'How old are you?', emoji: '🎂', response: '' },
          { portuguese: 'Adeus!', english: 'Goodbye!', emoji: '👋', response: '' }
        ],
        score: null,
        maxScore: 3
      },
      {
        ...
        items: [
          ...
          { portuguese: 'Obrigado/a', english: 'Thank you', emoji: '🙏', response: '' },
          { portuguese: 'Por favor', english: 'Please', emoji: '🙂', response: '' }
        ],
        score: null,
        maxScore: 5
      }
