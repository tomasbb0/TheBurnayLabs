  ...
  const assignments = [
    {
      ...
      description:
        "Practice with parent: Olha! (Look!), Ouve! (Listen!), Bate palmas! (Clap hands!), Salta! (Jump!), Senta-te! (Sit down!), Levanta-te! (Stand up!). Play Simon Says (O Simão diz) — parent says command, George does action. 5 minutes daily.",
      dueDate: getDate(3),
      progress: 0,
      createdAt: new Date(),
    },
    {
      ...
      description:
        'Learn 4 objects: livro (book) 📖, lápis (pencil) ✏️, bola (ball) ⚽, cadeira (chair) 🪑. Have parent point to each object at home and ask "O que é isto?" — George answers in Portuguese. Practice 5 min/day.',
      dueDate: getDate(3),
      progress: 0,
      createdAt: new Date(),
    },
    {
      ...
      description:
        'Practice answering: "Como te chamas?" → "Chamo-me George." and "Quantos anos tens?" → "Tenho cinco anos." Say each answer 3 times, every day. Parent asks randomly during the day!',
      dueDate: getDate(5),
      progress: 0,
      createdAt: new Date(),
    },
    {
      ...
      description:
        'Color scavenger hunt at home! Find 1 object of each color and say it in Portuguese: vermelho (red), azul (blue), amarelo (yellow), verde (green), preto (black), branco (white). Bonus: say "É vermelho!" (It\'s red!)',
      dueDate: getDate(4),
      progress: 0,
      createdAt: new Date(),
    },
    {
      ...
      description:
        "Sing/count 1-10 in Portuguese every day: um, dois, três, quatro, cinco, seis, sete, oito, nove, dez. Try counting backwards too! Use fingers while counting. 2 minutes daily.",
      dueDate: getDate(4),
      progress: 0,
      createdAt: new Date(),
    },
    {
      ...
      description:
        "Play the Build Your Rocket vocabulary game on the platform. Try to complete at least levels 1-3! Ask parent for help if needed.",
      dueDate: getDate(7),
      progress: 0,
      createdAt: new Date(),
    },
  ...
  const resources = [
    {
      ...
      description:
        "Portuguese textbook for young beginners (A0-A1). Colorful with games and activities.",
    ...
    },
    {
      ...
      description:
        'Free Portuguese government educational videos. Search for "1º ano Português".',
    ...
    },
    {
      ...
      description:
        "Portuguese school platform with free and paid content. 1º Ciclo section.",
